...
CREATE TABLE matchs (
    ...
    attendance INT,
    venue VARCHAR,
    season_history_victory_h INT,
    season_history_draw_h INT,
    season_history_defeat_h INT,
    season_history_victory_a INT,
    season_history_draw_a INT,
    season_history_defeat_a INT,
    formation_h VARCHAR,
    formation_a VARCHAR,
    referee VARCHAR,
    ar1 VARCHAR,
...
CREATE TABLE goalkeeper_stats (
    ...
    team_a VARCHAR NOT NULL,
    date_match DATE NOT NULL,
    name_gk VARCHAR NOT NULL,
    team_gk VARCHAR NOT NULL,
    age_gk VARCHAR,
    nation VARCHAR,
    min_played INT,
